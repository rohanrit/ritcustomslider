    ...
    mainSlider.addEventListener("click", function (e) {
      ...
      if (closestButton) {
        ...
        if (type === "video") {
          ...
          repdom = `<div id="${id}" data-type="video" data-src="${src}"><div class="responsive-embed" style="position: relative;display: block;height: 0;padding: 0;overflow: hidden;margin:0 auto;padding-bottom: ${ratio}%;" style="align-self:center;">
          <iframe width="560" height="315" src="${decodeURIComponent(
            src
